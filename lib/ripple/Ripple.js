...
var rippleFactory = function rippleFactory() {
  ...
  return function (ComposedComponent) {
      ...
      _createClass(RippledComponent, [{
        ...
        value: function render() {
          ...
          var _props2 = this.props,
              ...
              touchDisabled = _props2.touchDisabled,
              children = _props2.children,
              ripple = _props2.ripple,
              rippleClassName = _props2.rippleClassName,
              other = _objectWithoutProperties(_props2, ['onRippleEnded', 'rippleCentered', 'rippleMultiple', 'rippleSpread', 'touchDisabled', 'children', 'ripple', 'rippleClassName']);
    ...
    RippledComponent.propTypes = {
      ...
      touchDisabled: _react.PropTypes.bool
    };
